...
namespace DAO
{
    public class EstimateQuotationDAO
    {
        ...
        public string GetNextMaterailRequestId()
        {
            ...
            string qMaterialRequestId = "sp_web_GetNextESHeaderId";
        ...
        public DataTable GetMaterialRequestList(int customerId, int jobId, int engineerId)
        {
            ...
            string qMaterialRequest = "sp_web_GetESHeaderList";
        ...
        public DataTable GetMaterialRequestByID(int customerId, int jobId, string EngNo)
        {
            ...
            string qMaterialRequest = "sp_web_GetESHeaderByID";
        ...
        public DataTable GetMaterialRequestByMRNumber(int mrNumber)
        {
            ...
            string qMaterialRequest = "sp_web_GetSubEstimateByMRNumber";
        ...
        public DataTable GetMaterialRequestItemByMaterialRequestId(int materialRequestId)
        {
            ...
            SqlParameter[] param = null;
            string qSiteDetails = "sp_web_ESDetailsGetItemList";
        ...
        /// </summary>
        public bool SaveMaterialRequest(Entities.EstimateQuotation objMaterialRequest, DataTable DT)
        {
