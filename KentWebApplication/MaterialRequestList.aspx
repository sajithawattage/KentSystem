<%@ page title="" language="C#" masterpagefile="~/Site.Master" autoeventwireup="true" codebehind="MaterialRequestList.aspx.cs" inherits="KentWebApplication.MaterialRequestlist" %>
            ...
            <div class="row">
                <div class="col-lg-12 table-responsive">
                    <asp:gridview id="grdMaterialRequest" runat="server"
                        ...
                        pagesize="10">
                        <columns>
                            <asp:boundfield datafield="MRNumber" headertext="Material Request Number"
                                itemstyle-width="15%" />
